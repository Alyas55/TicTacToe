...
namespace TicTacToe
{
    public partial class Form1 : Form
    {
        ...
        public System.Drawing.Color determeneColor(string symbol)
        {
            if (symbol.Equals("O"))
            {
        ...
        public void checkDraw()
        {
            ...
            for (int i = 0; i < gameBoard.Length; i++)
            {
                if (gameBoard[i] != null)
                {
                    ...
                    {
                        reset();
                        MessageBox.Show("Its a draw !", "No winner this time", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
                }
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[0]);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[1]);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[2]);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[3]);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[4]);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[5]);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[6]);
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[7]);
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            Color buttonColor = determeneColor(gameBoard[8]);
